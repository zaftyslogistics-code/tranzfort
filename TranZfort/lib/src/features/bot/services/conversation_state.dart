...
class ConversationState {
  ...
  ConversationState copyWith({
    ...
    return ConversationState(
      ...
      activeSlotKey: clearActiveSlot ? null : (activeSlotKey ?? this.activeSlotKey),
    );
  }
}
...
class BotChatNotifier extends StateNotifier<ConversationState> {
  ...
  void setActiveSlot(String? key) {
    state = state.copyWith(activeSlotKey: key, clearActiveSlot: key == null || key.isEmpty);
  }

  void clearSlots() {
    state = state.copyWith(slots: const {}, currentIntent: BotIntent.unknown, clearActiveSlot: true);
  }
...
final botChatProvider = StateNotifierProvider<BotChatNotifier, ConversationState>((ref) {
