...
class SupabaseVerificationBackend implements VerificationBackend {
  ...
  Future<Map<String, dynamic>?> fetchProfile(String userId) async {
    ...
    return _client
        .from('profiles')
        .select(
          // P0.7 Simplified: Remove full aadhaar_number and pan_number from select
          'id, user_role_type, verification_status, verification_rejection_reason, verification_feedback_json, aadhaar_last4, aadhaar_front_document_path, aadhaar_back_document_path, pan_last4, pan_document_path, profile_photo_document_path',
        )
        .eq('id', userId)
        .maybeSingle();
  }
