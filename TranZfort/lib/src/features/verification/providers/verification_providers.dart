  ...
  Future<void> submitVerification({
    ...
    try {
      ...
      final Map<String, dynamic> supplierData = {
        ...
        'gst_photo_url': gstPhotoUrl,
        'updated_at': DateTime.now().toIso8601String(),
      };

      if (businessLicenceNumber != null && businessLicenceNumber.isNotEmpty) {
        supplierData['business_licence_number'] = businessLicenceNumber;
      }
      if (businessLicenceUrl != null) {
        supplierData['business_licence_doc_url'] = businessLicenceUrl;
      }
