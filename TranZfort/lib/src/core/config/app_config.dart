...
class AppConfig {
  /// Public legal pages (Play Console + in-app Settings).
  static const String privacyPolicyUrl = 'https://tranzfort.com/privacy';
  static const String termsOfServiceUrl = 'https://tranzfort.com/terms';
