      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          gradient: const LinearGradient(
            ...
            colors: [Color(0xFFF6FBFA), Color(0xFFFFF8EE)],
          ),
...
class _RouteMapPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final midY = math.min(origin.dy, dest.dy) - 22;
    ...
    canvas.drawCircle(origin, 7, Paint()..color = AppColors.success);
    canvas.drawCircle(origin, 3, Paint()..color = Colors.white);
    canvas.drawCircle(dest, 7, Paint()..color = AppColors.error);
    canvas.drawCircle(dest, 3, Paint()..color = Colors.white);
  }
