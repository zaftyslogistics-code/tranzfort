-- P2-8 follow-up: surface user-friendly unique conflict messages for profile upsert
-- This migration is additive so existing deployed databases receive the function update.
