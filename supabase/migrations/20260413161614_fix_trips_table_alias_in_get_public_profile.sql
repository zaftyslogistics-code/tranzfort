-- Fix trips table alias in get_public_profile to avoid column ambiguity
-- This fixes "column status does not exist" error
...
begin
  ...
  -- Get completed trips count (with table alias)
