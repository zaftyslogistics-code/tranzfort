-- Fix get_trip_detail_with_supplier RPC to use null for city/state (profiles table doesn't have these columns)
-- Also fix the key names to match Dart expectations
