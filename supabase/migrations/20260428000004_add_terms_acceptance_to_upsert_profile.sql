-- Add atomic terms acceptance to upsert_current_user_profile RPC
-- This makes profile update + terms acceptance a single database operation.

DROP FUNCTION IF EXISTS public.upsert_current_user_profile(
  user_role, TEXT, TEXT, TEXT, TEXT, DOUBLE PRECISION, DOUBLE PRECISION, TEXT
);
