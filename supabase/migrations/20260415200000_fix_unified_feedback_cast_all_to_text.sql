...
-- Issue: Multiple type mismatches between ratings and reviews tables
-- Fix: Cast all columns to text in both CTEs for UNION compatibility
-- Added debug logging to track record counts
-- Fixed GROUP BY error by using subquery for sorting
