-- Fix get_trip_detail_with_supplier RPC to return correct keys for Dart code
-- Dart expects: trip, supplier_profile, supplier_extension, dispute_summary
-- RPC was returning: trip, supplier, load, truck
