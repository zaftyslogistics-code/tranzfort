-- P3.4.1 — RPC to fetch trucker's trips with stage filtering and offset pagination
-- Replaces direct table read in SupabaseTruckerTripsBackend.fetchTrips()
...
COMMENT ON FUNCTION get_trucker_trips IS
  'Returns paginated list of trips for a trucker with optional stage filtering. Replaces direct table read in Flutter backend.';
