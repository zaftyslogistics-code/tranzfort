-- P1-6: Purge user-owned storage prefixes when account deletion is accepted.
...
BEGIN
  ...
  GET DIAGNOSTICS v_deleted_objects = ROW_COUNT;
  ...
  INSERT INTO audit_logs (
    ...
    jsonb_build_object(
      ...
      'storage_objects_deleted', v_deleted_objects
    ),
    'internal'
  );
