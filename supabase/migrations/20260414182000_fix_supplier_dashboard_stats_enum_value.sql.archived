-- Fix get_supplier_dashboard_stats RPC to use valid booking_status enum values
-- booking_status enum values: 'submitted', 'approved', 'rejected', 'withdrawn', 'superseded'
