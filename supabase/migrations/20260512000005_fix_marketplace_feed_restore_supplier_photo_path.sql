-- Fix: Restore supplier_photo_path in get_marketplace_feed RPC
-- Migration 20260430000000 incorrectly removed supplier_photo_path from supplier_summary,
-- assuming profile_photo_document_path didn't exist in profiles. It DOES exist
-- (added in 20260310000000_phase9_verification_document_fields.sql).
-- Without this fallback, supplier avatars show initials instead of real photos.
